...
import { Menu, X, RefreshCw, Link2, BarChart3, FileText, ArrowRight, Activity, Award, TrendingUp, Zap, Database } from 'lucide-react';
...
// Animated Dashboard Metrics Component
const AnimatedMetrics = () => {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, margin: "-100px" });
  
  const metrics = [
    { value: '95%', label: 'Tempo Economizado', delay: 0, color: 'text-cyan-400' },
    { value: '100%', label: 'Dados em Tempo Real', delay: 0.2, color: 'text-blue-400' },
    { value: '24/7', label: 'Monitorização', delay: 0.4, color: 'text-cyan-400' },
  ];
      ...
      {metrics.map((metric, i) => (
        ...
        >
          <motion.p
            ...
            transition={{ duration: 0.8, delay: metric.delay + 0.2, type: "spring" }}
...
const CustomDashboardsPage = () => {
  ...
  const features = [
    {
      icon: RefreshCw,
      title: 'SINCRONIZAÇÃO TEMPO REAL',
      subtitle: 'Dados Instantâneos',
  ...
  const timeline = [
    { title: 'AUDITORIA', description: 'Mapeamento de todas as fontes de dados atuais do negócio', icon: Database },
    { title: 'ARQUITETURA', description: 'Estruturação de como os dados serão conectados e processados', icon: Link2 },
    { title: 'DESIGN', description: 'Criação da interface focada na experiência e usabilidade', icon: BarChart3 },
    { title: 'IMPLEMENTAÇÃO', description: 'Integração final e formação completa da equipa', icon: Zap },
  ];
    ...
    <div className="bg-black min-h-screen">
      ...
      >
        ...
        >
          <div className="relative">
            <BarChart3 className="w-32 h-32 md:w-48 md:h-48 text-cyan-400" strokeWidth={0.5} />
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          >
            Dashboards personalizados que transformam <span className="text-cyan-400 font-semibold">dados dispersos</span> em decisões rápidas. 
            Todas as suas métricas, num <span className="text-blue-400 font-semibold">único lugar</span>.
          </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-white/70 leading-relaxed mb-8">
                Quantas <span className="text-cyan-400 font-semibold">horas por semana</span> perde a copiar dados entre plataformas? 
                Enquanto concorrentes decidem em <span className="text-blue-400 font-semibold">segundos</span>, você ainda está a consolidar Excel.
              </p>
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-cyan-600/20 to-blue-600/20 border border-cyan-500/30 rounded-2xl px-6 py-4 backdrop-blur-sm">
                ...
                <span className="text-cyan-400 font-bold text-lg">Tempo Real. Uma Única Fonte da Verdade.</span>
              </div>
            </motion.div>
            ...
            >
              <div className="relative rounded-3xl overflow-hidden border-2 border-cyan-500/20 shadow-2xl shadow-cyan-500/10">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-cyan-400 text-sm font-semibold mb-1">Redução em Trabalho Manual</p>
                      <p className="text-white text-3xl font-black">-95%</p>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className={`group relative bg-gradient-to-br ${feature.gradient} backdrop-blur-sm border-2 ${feature.borderColor} rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 overflow-hidden`}
              >
                ...
                <div className="relative z-10">
                  <div className="relative inline-block mb-6">
                    <feature.icon className={`w-14 h-14 ${feature.iconColor} stroke-[1.5]`} />
                    <div className={`absolute inset-0 blur-xl ${feature.iconColor} opacity-30`}></div>
                  </div>
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                  <div className={`absolute inset-0 rounded-3xl blur-xl ${feature.gradient}`}></div>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="relative py-32 md:py-40 px-4 md:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            Vamos construir o <span className="text-cyan-400 font-semibold">dashboard perfeito</span> para o seu negócio. 
            Decisões rápidas. <span className="text-blue-400 font-semibold">Resultados reais</span>.
          </motion.p>
