      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 pt-24 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-[15px] text-white/60 leading-relaxed max-w-sm" style={{ fontFamily: 'Inter, sans-serif' }}>
          ...
          <div>
            <h3 
              className="text-[13px] font-bold uppercase tracking-[2px] text-white/50 mb-6"
          ...
          <div>
            ...
            <p className="text-[14px] text-white/60 mb-6" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                required
                className="flex-1 bg-white/5 border-b-2 border-white/20 px-4 py-3 text-white placeholder:text-white/40 focus:border-white focus:outline-none transition-colors duration-300"
                style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px' }}
              />
              <button
                type="submit"
                className="bg-white text-black px-6 py-3 font-semibold rounded-md hover:bg-white/90 transition-all duration-300 whitespace-nowrap"
                style={{ fontFamily: 'Inter, sans-serif', fontSize: '14px' }}
              >
                Subscrever
              </button>
